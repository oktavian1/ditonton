...
@GenerateMocks([TvPopularNotifer])
void main() {
  late MockTvPopularNotifer mockNotifier;

  setUp(() {
    mockNotifier = MockTvPopularNotifer();
  });

  Widget _makeTestableWidget(Widget body) {
    return ChangeNotifierProvider<TvPopularNotifer>.value(
      value: mockNotifier,
      child: MaterialApp(
        home: body,
      ),
